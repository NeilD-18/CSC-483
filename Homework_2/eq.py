...
def equality(X, Y, n):
    """
    Checks if two n-bit integers X and Y are equal using cvc5's Boolean logic.
    ...
    Steps:
      ...
      4. Build the overall equality by asserting, for each bit position i, that x_i equals y_i.
      5. Combine the bit-wise equalities using an AND operation.
      6. Check satisfiability and extract the model.
      7. Output the result indicating whether equality holds.
